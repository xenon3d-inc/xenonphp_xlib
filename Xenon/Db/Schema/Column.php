...
class Column
{
    ...
    protected $attributes = []; // User-defined attributes (used especially with InlineTableEdit), attrs starting with underscode in meta (@_attrname)
                                //      label, hint, readonly, createonly, required, options_label, type, strip_tags, placeholder, checkbox, autocomplete, autocomplete_ajax, regexp, minlength, maxlength, min, max ...
